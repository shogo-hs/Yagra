...
- 未完了: G05-I07, G05-I08
- 現在地: M-05〜M-09 で機能到達（可視化・フォーム編集・DnD 編集）は完了。M-10 の実装として Add Node の自動配置、Quick Guide、エッジ線クリック選択、Rewire トグル導線に加え、Raw JSON 常時表示を撤去して 2カラム/広い Canvas へ整理し、操作理解性の改善を継続中。
